...
tf.app.flags.DEFINE_float("p1", 0.02, "p1.")
tf.app.flags.DEFINE_float("p2", 0.01, "p2.")
tf.app.flags.DEFINE_float("p3", 0.002, "p3.")
...
def main(argv):
    ...
    with tf.Session() as sess:
        ...
        df.to_csv("./logs/csv/vgg_rmsprop_({})_({})_({})_({}).csv".format(FLAGS.p1, FLAGS.p2, FLAGS.p3, FLAGS.r))
