...
tf.app.flags.DEFINE_float("p2", 0.0005, "p2.")
...
def main(argv):
    ...
    with tf.Session() as sess:
        ...
        # df.to_csv("./logs/csv/mlp_rmsprop_({})_({})_({})_({}).csv".format(FLAGS.p1, FLAGS.p2, FLAGS.p3, FLAGS.r))
        df.to_csv("./logs/csv/mlp_rmsprop.csv")
