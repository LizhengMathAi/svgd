...
# ===================================================================
tf.app.flags.DEFINE_float("p1", 0.1, "p1.")
tf.app.flags.DEFINE_float("p2", 0.05, "p2.")
tf.app.flags.DEFINE_float("p3", 0.01, "p3.")
tf.app.flags.DEFINE_float("r", 0.0001, "r.")
...
def main(argv):
    ...
    with tf.Session() as sess:
        ...
        # df.to_csv("./logs/csv/mlp_sgd_({})_({})_({})_({}).csv".format(FLAGS.p1, FLAGS.p2, FLAGS.p3, FLAGS.r))
        df.to_csv("./logs/csv/mlp_sgd.csv")
